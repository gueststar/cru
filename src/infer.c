...
_cru_inferred_filter (f, s, err)
	  ...
	  // needed.
	  //
	  // If the edge test fold is not specified, then the filter calls
	  // for all edges in the graph to be retained. If the edge test is
	  // specified, then its reduction is never needed.
	  //
